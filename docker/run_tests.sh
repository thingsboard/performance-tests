...
function install_dependencies() {
    ...
    mvn install:install-file -Dfile=/root/tools-1.4.0.jar -DgroupId=org.thingsboard -DartifactId=tools -Dversion=1.4.0 -Dpackaging=jar
    mvn install:install-file -Dfile=/root/data-1.4.0.jar -DgroupId=org.thingsboard.common -DartifactId=data -Dversion=1.4.0 -Dpackaging=jar
}
